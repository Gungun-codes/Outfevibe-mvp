...
function Home() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            setLoading(true);
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("feedback").insert({
                name: name,
                message: message,
